...
Route::group(['middleware'=>'auth'],function(){
    ...
    Route::get('profil', 'App\Http\Controllers\UserController@profile')->middleware('checkRole:Super Admin');
    ...
    Route::get('pengurus/yajra', 'App\Http\Controllers\PengurusController@yajra')->middleware('checkRole:Super Admin, Admin');
    ...
    Route::get('agenda/yajra', 'App\Http\Controllers\AgendaKegiatanController@yajra')->middleware('checkRole:Super Admin, Admin');
